      ...
      <table className="w-full text-sm">
        <tbody>
          {entries.map(([key, value], index) => (
            ...
            >
              <td className="px-4 py-3 font-medium text-gray-600 dark:text-gray-400 w-2/5 rounded-l-lg">
                {getLabel(key)}
              </td>
              <td className="px-4 py-3 text-gray-900 dark:text-white font-semibold rounded-r-lg">
