...
function CatalogPageInner() {
 ...
 className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-gray-900 focus:outline-none focus:outline-none focus:border-gray-900"
 />
 {searchInput && (
 ...
 <button type="submit" className="px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors">
 Cari
 </button>
 </form>
 ...
 className={`block w-full text-left px-3 py-1.5 rounded-lg text-sm transition-colors ${!filters.category ?'bg-gray-50 text-gray-900 font-medium' :'text-gray-600 hover:bg-gray-50'}`}
 >
 Semua Kategori
 </button>
 {categories.map((cat) => (
 ...
 {/* Sort */}
 <div>
 <h3 className="text-sm font-medium text-gray-700 mb-2">Urutkan</h3>
 <select
 value={filters.sort}
 ...
 className={`w-9 h-9 rounded-lg text-sm font-medium transition-colors ${p === filters.page ?'bg-blue-600 text-white' :'border border-gray-200 hover:bg-gray-50'}`}
 >
 {p}
 </button>
 );
