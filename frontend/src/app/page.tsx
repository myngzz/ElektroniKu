...
export default function HomePage() {
 ...
 <form onSubmit={handleSmartSearch} className="flex gap-0 max-w-xl mx-auto border border-gray-200">
 ...
 className="w-full pl-11 pr-4 py-3.5 bg-white text-gray-900 text-sm focus:outline-none"
 />
 </div>
 <button type="submit" disabled={isSmartSearching} className="px-6 py-3.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white text-sm font-medium transition-colors flex items-center gap-2 shrink-0">
 ...
 <button key={hint} onClick={() => setSmartSearchQuery(hint)} className="text-xs text-gray-500 border border-gray-200 hover:border-gray-400 px-3 py-1.5 transition-colors">
 {hint}
 </button>
 ))}
 </div>
 ...
 <Link href="/catalog" className="text-xs text-gray-500 hover:text-gray-900 flex items-center gap-1 transition-colors">Lihat semua <ChevronRight className="w-3.5 h-3.5" /></Link>
 </div>
 ...
 <Link href="/catalog?featured=true" className="text-xs text-gray-500 hover:text-gray-900 flex items-center gap-1 transition-colors">Lihat semua <ChevronRight className="w-3.5 h-3.5" /></Link>
 </div>
 ...
 <span className="text-xs text-gray-900 flex items-center gap-1 font-medium">Coba <ArrowRight className="w-3 h-3" /></span>
 </div>
 </Link>
 ))}
 </div>
 ...
 <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 tracking-tight">Jelajahi {'>'}60 Produk Elektronik</h2>
 <p className="text-gray-500 mb-8 text-sm max-w-md mx-auto">Rekomendasi sesuai kebutuhan dan budget dengan bantuan AI.</p>
 <div className="flex flex-wrap gap-3 justify-center">
 <Link href="/catalog" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors text-sm rounded">Jelajahi Katalog</Link>
 <Link href="/ai-assistant" className="px-6 py-3 border border-gray-300 hover:border-gray-500 text-gray-700 hover:text-gray-900 font-medium transition-colors text-sm rounded">Tanya AI</Link>
 </div>
 </div>
 </section>
 </div>
