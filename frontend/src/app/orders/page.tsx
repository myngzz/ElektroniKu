      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {orders.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link href="/catalog" className="px-5 py-2.5 bg-gray-900 hover:bg-gray-800 text-white rounded-xl text-sm transition-colors">
              Mulai Belanja
            </Link>
          </div>
        ) : (
              ...
              return (
                <div key={order._id} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <Link href={`/orders/${order._id}`} className="flex items-center gap-1 text-sm text-gray-900 dark:text-gray-500 hover:underline">
