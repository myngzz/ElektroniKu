...
export default function AdminUsersPage() {
 ...
 <span className="text-sm text-gray-500">{users.length} pengguna terdaftar</span>
 </div>
 ...
 <UserCircle2 className="w-5 h-5 text-gray-900" />
 </div>
 ...
 <td className="py-3 px-4">
 <span className={`inline-flex items-center gap-1 text-xs px-2 py-1 rounded-full font-medium ${user.role ==='admin' ?'bg-gray-100 text-gray-700' :'bg-gray-100 text-gray-600'}`}>
