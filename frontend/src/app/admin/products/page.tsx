      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full max-w-sm pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-sm"
          />
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 dark:bg-gray-700/50">
                  <tr>
                    <th className="text-left px-4 py-3 text-gray-600 dark:text-gray-400 font-medium">Produk</th>
                    <th className="text-left px-4 py-3 text-gray-600 dark:text-gray-400 font-medium">Harga</th>
                    <th className="text-left px-4 py-3 text-gray-600 dark:text-gray-400 font-medium">Stok</th>
                    <th className="text-left px-4 py-3 text-gray-600 dark:text-gray-400 font-medium">Rating</th>
                    <th className="text-left px-4 py-3 text-gray-600 dark:text-gray-400 font-medium">Aksi</th>
                  </tr>
                </thead>
                    ...
                    <tr key={p._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-gray-900 dark:text-white line-clamp-1 max-w-[200px]">{p.name}</p>
                      ...
                      <td className="px-4 py-3">
                        <span className={`font-medium ${p.stock === 0 ? 'text-red-500' : p.stock <= 5 ? 'text-orange-500' : 'text-green-600 dark:text-green-400'}`}>
                          {p.stock}
                        </span>
                      </td>
            ...
            {products.length === 0 && (
              <p className="text-center py-12 text-gray-500 dark:text-gray-400">Tidak ada produk ditemukan</p>
            )}
          </div>
        )}
      </div>
