...
export default function WishlistPage() {
 ...
 <div key={product._id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden group">
 ...
 className="absolute top-2 right-2 p-1.5 bg-white rounded-lg text-red-400 hover:text-red-600 opacity-0 group-hover:opacity-100 transition-opacity shadow"
 >
 <Trash2 className="w-4 h-4" />
 </button>
 </div>
 <div className="p-3">
 <Link href={`/catalog/${product._id}`} className="font-medium text-sm text-gray-900 line-clamp-2 hover:text-gray-900 block mb-1">
 {product.name}
 </Link>
